...
Choosing an appropriate probability distribution for each model input is the first and most critical step in PSA.

As demonstrated in the ISPOR good practice guidelines for uncertainty analysis, high-quality research requires selecting probability distributions that appropriately reflect the nature of the data being modeled. The guidelines also provide practical recommendations for choosing distributions tailored to different data types. The full paper is available [here](https://www.valueinhealthjournal.com/article/S1098-3015(12)01659-2/fulltext?_returnURL=https%3A%2F%2Flinkinghub.elsevier.com%2Fretrieve%2Fpii%2FS1098301512016592%3Fshowall%3Dtrue).

This selection requires both an understanding of statistical distributions and domain knowledge in health economics or epidemiology.
